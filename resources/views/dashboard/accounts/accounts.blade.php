        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="ink" style="float:right">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_new_account">Add New Account</button>
                </div>
            </div>
        </div>
        <div class="row">
...
<!-- Add New Account -->
<div class="modal fade" id="add_new_account" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
